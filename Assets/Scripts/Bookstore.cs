...
public class Bookstore : MonoBehaviour
{
    ...
    public Button BookExternalLinkbtn; // Link to real book for users to buy if they want
    ...
    void Start()
    {
        ...
        BookExternalLinkbtn.gameObject.SetActive(false);
    ...
    private void EnterBookButton(GameObject p_oContent, int p_iIndex, enSection p_enSection)
    {
        ...
        if (Action == enAction.Purchase)
        {
            ...
            BookExternalLinkbtn.GetComponentInChildren<TextMeshProUGUI>().text = "Amazon Purchase Link";
            BookExternalLinkbtn.onClick.RemoveAllListeners(); // Clear any previous listeners
            BookExternalLinkbtn.onClick.AddListener(() => OpenExternalPurchaseLink(BookStoreItems[p_iIndex].ExternalPurchaseLink));
            BookExternalLinkbtn.gameObject.SetActive(true);
        }
        else
        {
    ...
    private void OpenExternalPurchaseLink(string url)
    {
    ...
    {
            new BookStoreItem (
                "I Inc Career Planning",
                50f,
                "IT~HR~SE",
                "Book_1",
                "Teaches students how to market themselves effectively in today's competitive professional environment.",
                "",
                BookStoreItem.Prof,
                "https://a.co/d/as3DdOi"),
            new BookStoreItem (
                "Tiger in the Office",
                50f,
                "IT~HR~SE",
                "Book_3",
                "Using lessons developed by entrepreneurs, you will learn how to pursue your next career steps, rediscover buried career goals and learn to take action toward those goals.",
                "",
                BookStoreItem.Team,
                "https://a.co/d/ewTOUXC"),
            new BookStoreItem(
                "The Start-up of You",
                50f,
                "IT~HR~SE",
            ...
            new BookStoreItem (
                ...
                "SE",
                "Book_1",
                "Covers the most essential basics of Software Engineering, including project management, determining measurables, reducing costs, and much more!",
                "",
                BookStoreItem.Lead,
                "https://a.co/d/gallFWT"),
            new BookStoreItem(
            ...
            new BookStoreItem (
                ...
                "SK",          
                "Book_1", 
                "Communication Book to improve skill", 
                "Dialog", 
                BookStoreItem.Com, 
                "https://a.co/d/54WDveM"),
            new BookStoreItem ("Brain Teasers",                                   50f, "SK",          "Book_3", "Critical Thinking Book to improve Skill", 
                "", 
                BookStoreItem.Crit, 
                "https://a.co/d/ibAfIzJ"),
            new BookStoreItem ("Team Synergy",                                    
                20f, 
                "HR",          
                "Book_1", 
                "How to create Team Synergy while working with your employees, and  with their unique life experiences, perspectives, talents, and communication styles.", 
                "",BookStoreItem.Team, 
                "https://a.co/d/fhWKtiS"),
            new BookStoreItem ("Hiring Manager's Guide to Everything",            
                80f, 
                "HR",          
                "Book_3", 
                "This book covers a basic overview of the kinds of things that a Hiring Manager would need to know, such as conducting job analysis, planning a recruiting strategy, prescreening candidates, and asking the right questions.", 
                "",
                BookStoreItem.Lead, 
                "https://a.co/d/cVc9m1h"),
            ...
            new BookStoreItem (
                ...
                "HR",
                "Book_3",
                "This book explains the 20 most important federal employment laws that come up in the workplace.",
                "",
                BookStoreItem.Prof,
                "https://a.co/d/239sCB9"),
            new BookStoreItem (
                "CompTIA A+ Certification Guide",
                80f,
                "IT~SE",
                "Book_1",
                "An in-depth guide to the A+ Certification exams, with troubleshooting steps and previous exam examples.",
                "",
                BookStoreItem.Tech,
                "https://a.co/d/iFw5vcX"),
            new BookStoreItem (
                "Intro to Hardware",
                40f,
                "IT",
                "Book_3",
                "An overview of the hardware components in a typical consumer computer, including troubleshooting and installation guides. ",
                "",
                BookStoreItem.Tech,
                "https://a.co/d/0bp9Dhn"),
            new BookStoreItem (
                "Troubleshooting for Dummies",
                20f,
                "IT",
                "Book_1",
                "How to troubleshoot anything! Mostly applies to computers and other electronics, but also teaches you troubleshooting as a way of problem solving.",
                "",
                BookStoreItem.Tech,
                "https://a.co/d/0YTxQz8"),
            ...
            new BookStoreItem (
                ...
                "SE",
                "Book_3",
                "A basic overview of the Python programming language, with Pi-specific projects as well as programming basics to get you programming fast!",
                "",
                BookStoreItem.Tech,
                "https://a.co/d/ejEShRg"),
            ...
            new BookStoreItem (
                ...
                "SK",
                "Book_3",
                "Teamwork Book to improve skill",
                "",
                BookStoreItem.Team,
                "https://a.co/d/3vPbxaq"),
...
public class BookStoreItem
{
    ...
    public string book;
    public string ExternalPurchaseLink;
    public string bookStoreStats; //added by Don Murphy
    public static readonly string Lead = "#INCREASE#*Lead* +1 to Leadership!";
    ...
    public BookStoreItem(string p_oTitle, float p_fCost, string p_oFlags, string p_oBook, string p_oDescription, string p_oDialog, string upBookStats, string p_ExternalPurchaseLink)
    {
        Title = p_oTitle;
        Cost = p_fCost;
        Flags = p_oFlags;
        ...
        book = p_oBook;
        Dialog = p_oDialog;
        ExternalPurchaseLink = p_ExternalPurchaseLink;
